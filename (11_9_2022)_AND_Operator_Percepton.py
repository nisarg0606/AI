...
# Perfrom AND operation on two arrays and print error and training accuracy on every epoch
...
perceptron = Percepton(2)  # 2 inputs for AND
...
print("perceptron.weights --> ", perceptron.weights)  # [ 0.   0.1  0.1]
